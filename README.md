[![DOI](https://zenodo.org/badge/246008003.svg)](https://zenodo.org/badge/latestdoi/246008003)

A package for working with high resolution gridded population data from the Socioeconomic Data and Applications Center (sedac). 
